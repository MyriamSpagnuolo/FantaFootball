...
public class LeagueInvite {
    ...
    @SequenceGenerator(
            name = "league_invite_id_seq_gen",
            sequenceName = "seq_league_invite_id",
            allocationSize = 1
    )
    @Column(name = "id")
    private Long id;
    ...
    public LeagueInvite(League league, AppUser invitedBy, AppUser invitedUser, LeagueInviteStatus status) {
        this.league = league;
    ...
    public LeagueInviteStatus getStatus() {
        return status;
    }

    public void setStatus(LeagueInviteStatus status) {
        this.status = status;
    }
